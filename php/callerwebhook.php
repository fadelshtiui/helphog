...
if(isset($_POST['From'])){
    ...
    $hookObject = json_encode([
        ...
        "embeds" => [
            ...
            [
                ...
                "description" => 'Caller is requesting a callback',
    ...
    $response->say('Great! We got you on the list. You can be expecting a call from a different number within the next 30 minutes. Goodbye.');
