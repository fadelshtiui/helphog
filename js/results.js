:root {
   ...
   * {
   ...
   .address .profile__cta {
     padding: 0;
   }
   
   .address a.addressbutton {
     outline: none;
     color: black;
     text-align: center;
     display: inline-block;
   ...
   .highlightEffect {
     box-shadow: 0px 0px 96px -38px rgba(0, 0, 0, 0.5) inset, 0px 0px 0px 100vh rgba(0, 0, 0, 0.5);
   }
   ...
   a.button:active, a.button.active, input.button:active, input.button.active {
   ...
   a.button.secondary:active, a.button.secondary:focus, a.button.secondary.active, input.button.secondary:active, input.button.secondary:focus, input.button.secondary.active {
   ...
   .profile__image img {
     ...
     height: 100%;
     object-fit: cover;
     border-bottom: 7px solid #1ecd97;
   }
