...
app.controller('dateTimeCtrl', function ($scope) {
    ...
    ctrl.selected_date.setHours(ctrl.selected_date.getHours());
    ctrl.selected_date.setMinutes(ctrl.selected_date.getMinutes() + 25);
    ...
    ctrl.updateDate = function (newdate) {
        ...
        let dow = newdate.substring(0, 3)
        id('dow').value = dow
        id('date').value = newdate.substring(4, 15)
        ...
        link: function (scope, element, attrs, ctrl, transclude) {
            ...
            function getDaysInMonth() {
                ...
                while (date.getMonth() === month) {
                    ...
                    if (dateDiffInDays(today, date) > 5) {
                        showday = false;
                    }
